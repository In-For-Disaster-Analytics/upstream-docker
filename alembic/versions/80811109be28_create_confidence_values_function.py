"""create confidence values function

Revision ID: 80811109be28
Revises: a4b756aac3cf
Create Date: 2025-04-02 09:04:26.101618
...
revision: str = '80811109be28'
down_revision: Union[str, None] = 'a4b756aac3cf'
...
def downgrade() -> None:
    """Downgrade schema."""
    op.execute("""
    DROP FUNCTION IF EXISTS get_sensor_aggregated_measurements;
    """)
