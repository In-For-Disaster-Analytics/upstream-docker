...
def upgrade() -> None:
    ...
    op.create_index('idx_campaign_sensor_types', 'campaign_sensor_types', ['sensor_type'], unique=False)
    ...
    op.create_index(op.f('ix_stations_stationid'), 'stations', ['stationid'], unique=False)
    ...
    sa.ForeignKeyConstraint(['stationid'], ['stations.stationid'], ),
    ...
    sa.ForeignKeyConstraint(['sensorid'], ['sensors.sensorid'], ),
    sa.PrimaryKeyConstraint('measurementid')
    )
    op.create_index(op.f('ix_measurements_measurementid'), 'measurements', ['measurementid'], unique=False)
    op.create_table('sensorobjects',
