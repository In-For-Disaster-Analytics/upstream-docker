...
@app.post("/uploadfile/campaign/{campaign_id}/station/{station_id}/sensor/")
#async def post_sensor_and_measurement(campaign_id:int , uploaded_file: Annotated[UploadFile, File(...)], station_id: int, current_user: User = Depends(get_current_user)):
