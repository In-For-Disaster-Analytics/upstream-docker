...
from app.api.v1.schemas.measurement import MeasurementItem, MeasurementPagination
...
class MeasurementService:
    ...
    def list_measurements(self, sensor_id: int, start_date: datetime, end_date: datetime, min_value: float, max_value: float, page: int = 1, limit: int = 20) -> MeasurementPagination:
